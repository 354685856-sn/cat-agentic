    ...
    <div className="app-shell">
      ...
      {activeView === 'home' ? <section className="chat-home-shell" aria-label="Cat Codex home">
        <aside className="chat-sidebar">
          ...
          <div className="chat-sidebar-actions"><button className="chat-new-button" onClick={() => { setInput(''); setNotice(''); setActiveView('home') }}><Icon name="plus" /> New chat</button><button className="chat-rail-button" aria-label="Search chats"><Icon name="search" /></button></div>
